      ...
      >导出</el-button>
       <div style="display: inline-block">
          <el-upload
            ...
            :auto-upload="true"
          >
            <el-button size="mini" class="filter-item" type="danger" plain icon="el-icon-upload2">导入</el-button>
          </el-upload>
        </div>
      <!--右侧-->
      <slot name="right" />
...
export default {
  ...
  data() {
    return {
      ...
      uploadUrl:this.baseApi+ '/api/fileUploadzw/personImport',
      headers: {
