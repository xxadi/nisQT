      ...
      <el-col :xs="15" :sm="18" :md="19" :lg="20" :xl="20">
        <el-row>
          ...
          <el-table ref="table" @row-click="openDetails" size="mini"
            ...
            <el-table-column :show-overflow-tooltip="true" align="left" width="70" prop="state" label="网报状态">
              <template slot-scope="scope">
                <span  v-if="scope.row.wbState=='1' " style="color:#30B08F ">已网报</span >
                <span  v-else style="color:#bbbbbb ">未网报</span >
              </template>
            </el-table-column>
            <el-table-column :show-overflow-tooltip="true" align="left" width="150" prop="liushuihao" label="流水号">
              <template slot-scope="scope">
                <el-button   @click="dialogVisible = true" icon="el-icon-user-solid" type="text ">
            ...
            <el-table-column label="操作" width="220" prop="enabled"  fixed="right">
              <template slot-scope="scope">
                ...
                <el-button
                  type="text" size="small"
                  @click="handleReback(scope.$index, scope.row)">退卡
                </el-button>
                <el-button
                  type="text" size="small"
                ...
                <el-button
                  type="text" size="small"
                  @click="handleWangBao(scope.$index, scope.row)">网报
                </el-button>
                <router-link
                  :to="{ path: '/reportcard/index', query: { user: scope.row , cardType:2 } }"
                >
                <el-button
...
export default {
  ...
  methods: {
    ...
    // 网报
    handleWangBao: function (val,item) {
      this.$notify.error({
        title: '网报',
        message: '请配置正确IP'
      });
