<template>
  <div>
    ...
    <!--试题列表展示表格-->
    <div class="table">
      <span style="font-size:15px; font-weight:bold">题库列表</span>
      <div class="btn_fabu">
        <el-button class="button" size="mini" @click="dialogFormVisible = true">添加试题</el-button>
      </div>
    ...
    <el-button type="primary" @click="confirmForm">确 定</el-button>
      ...
      <el-table :data="crud.data" border stripe size="mini" style="width: 100%"
        ...
        <el-table-column prop="questName" label="题目名字" align="center"></el-table-column>
        <el-table-column prop="questType" label="属性" align="center" width="120">
        ...
        <el-table-column prop="questTitle" label="分类" align="center" width="120">
          <template slot-scope="scope">
        ...
        <el-table-column prop="questDifficulty" label="难度" align="center" width="120">
          <template slot-scope="scope">
        ...
        <el-table-column prop="unread" label="正确率" align="center" width="120">
          <!-- <template slot-scope="scope">
        ...
        <el-table-column label="操作" align="center">
          <template slot-scope="scope">
            ...
            <el-button
              type="text"
              size="small"
              @click="toUpdateNote(scope.row.questId)"
              style="color: #F2B206"
            >编辑</el-button>
          </template>
        </el-table-column>
