  ...
  <div>
    ...
    <div class="table">
      ...
      <el-table :data="crud.data" border stripe size="mini" style="width: 100%"
        ...
        <el-table-column prop="fileName" label="文章名字" align="center"></el-table-column>
        ...
        <el-table-column label="操作" align="center">
          <template slot-scope="scope">
            ...
            >
              <el-button style="color: sandybrown;font-weight: bold" type="text" size="small"
              >编辑
              </el-button
              >
            </router-link>
            <el-button v-if="scope.row.fileState==='1'" type="text" size="small"
                       style="color: #44A791;font-weight: bold"
                       @click="stopUse(scope.row)">设置隐藏
            </el-button>
            <el-button v-else type="text" size="small" style="color: #1900FF;font-weight: bold"
